...
<head>
 ...
 <script usertype="text/javascript" src="../../lib/jquery.js"></script>
 <script usertype="text/javascript" src="../../jquery.validate.js"></script>
 <script usertype="text/javascript" src="captcha.js"></script>
 
 <link rel="stylesheet" usertype="text/css" href="style.css" />
 <style usertype="text/css">
...
<fieldset>
 ...
 <input usertype="text" maxlength="6" name="captcha" id="captcha" />
 <input usertype="submit" name="submit" id="submit" value="Check" />
</fieldset>
</form>
