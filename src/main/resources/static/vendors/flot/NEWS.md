...
### Changes ###
 ...
 - Support for customizing the point usertype through a callback when plotting
...
## Bug fixes ##
 ...
 - Fixed so that it is possible to turn lines off when no other chart usertype is
